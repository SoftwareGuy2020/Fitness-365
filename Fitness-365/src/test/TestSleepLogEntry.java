...
public class TestSleepLogEntry {
	...
	public static void setUpBeforeClass() throws Exception {
		entry1 = new SleepLogEntry(LocalDate.of(1997, 2, 11), LocalTime.of(22, 30), LocalTime.of(8, 0), 0);
		entry2 = new SleepLogEntry(LocalDate.of(1997, 2, 12), null, LocalTime.of(8, 0), 0);

		entry3 = new SleepLogEntry(LocalDate.of(1997, 2, 12), LocalTime.of(12, 0), null, 0);
