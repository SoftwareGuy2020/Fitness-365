...
/**
 * Wraps up the various password encryption and authentication methods used in
 * the program.
 * 
 * @author Travis
 *
...
public final class PasswordEncryption {
	...
	/**
	 * Authenticates the plaintext password with the hashes to verify if the log in
