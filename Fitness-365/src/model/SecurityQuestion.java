...
public enum SecurityQuestion {
	DOG("What was your first dog's name?"), MOTHER("What is your mother's maiden name?"),
	JOB("In what town or city was your first full time job?"),
	LICENSE("What are the last five digits of your driver's licence number?"),
	OLDEST_CHILD("What is the middle name of your oldest child?"),
	ADDRESS("What was the house number and street name you lived in as a child?"),
	SCHOOL("What primary school did you attend?"),
	PARTNERS_MOTHER(" What is your spouse or partner's mother's maiden name?"),
	PARENTS_MET("In what town or city did your mother and father meet?"),
